...
<body>
    ...
    <form method="post">
        ...
        <img src="gueco.png" alt="" width="<?php echo empty($imgSize) ? '10' : $imgSize; ?>%" height="<?php echo empty($imgSize) ? '10' : $imgSize; ?>%" style="border:5px solid <?php echo empty($borderColor) ? '#000000' : $borderColor; ?>;">
    </form>
